...
export default {
  ...
  dashboards: [
    {
      ...
      display_hero: false,
      display_kpis: false,
      published_at: '2017-01-07T05:07:52.208Z',
    },
    {
      id: 2,
      ...
      notes: [
        ...
        },
        {
          ...
          body:
            'The Australian Citizenship Appointment Booking Service makes it quicker, easier and more convenient for users to reschedule a citizenship test appointment. Prior to the introduction of the online service, users were only able to change their appointment by calling the Department. The public beta release of the service is currently available in Melbourne, Victoria.',
        },
        {
          title: 'User satisfaction',
          body:
            'User satisfaction measures the percentage of users who responded "satisfied" and "very satisfied" with the appointment booking service using the feedback kiosks located in the Department’s citizenship areas.',
        },
        { title: 'Cost per transaction', body: 'This data is not available.' },
        {
          title: 'Digital take-up',
          body:
            'Digital take-up measures the number of users who had an appointment booked using the new service as a percentage of all appointments that have been made Australia-wide.',
        },
        {
          title: 'Completion rate',
          body:
            'Completion rate measures the number of users who were able to use the digital service without having to contact the Department for assistance when rescheduling their appointment.',
        },
      ],
    ...
    },
    {
      ...
      description:
        'This beta release of the Digital Marketplace provides a richer and simpler environment for technology procurement, enabling businesses, especially SMEs and start-ups, to provide specialist digital services to Government. Our vision is for an end to end digital environment which accommodates the level of simplicity creativity and structure appropriate to each procurement interaction.',
      notes: [
        {
        ...
        {
          title: 'Who is the user group of the Digital Marketplace?',
          body:
            'Government buyers and sellers of digital services are the primary target user groups.',
        },
        {
          title: 'User satisfaction',
          body:
            'We will update the Dashboard in the near future with this data.',
        },
        {
        ...
        {
          title:
            'Metrics relating to the operations of the marketplace will be published as the data becomes available.',
        },
      ],
      url: 'https://gov.au/marketplace',
      target_users:
        'Government buyers and sellers of digital services are the primary target user groups.',
      display_hero: true,
      display_kpis: true,
      published_at: '2017-01-07T05:07:57.580Z',
    },
    {
      id: 3,
      name: 'Hobby or Business Tool',
      description:
        'This public beta release of the tool is for people who are getting money or intend to get money from creative works, and are unsure if they are a hobby or a business. The tool guides them on their government obligations.',
      notes: [
        {
        ...
        },
        {
          ...
          body:
            'The first release applies to artists, creatives and makers. Future enhancements to the tool, building on the public beta, will add new user groups, and over time, the digital take-up figure will reflect the increasing number of users who are able to use it.',
        },
        {
          title: 'User satisfaction',
          body:
      ...
      display_hero: true,
      display_kpis: true,
      published_at: '2017-01-07T05:07:56.436Z',
    },
    {
      id: 4,
      name: 'Import Permit Validation Service',
      description:
        'This service simplifies the permit validation process for importers and brokers. It enables the digital validation of permits directly with the Permit Issuing Authority.',
      notes: [
        {
          title: 'What is the Import Permit Validation Service?',
          body:
            'This service simplifies the permit validation process for importers and brokers. It enables the digital validation of permits directly with the Permit Issuing Authority.',
        },
        {
          title: 'User satisfaction',
          body:
            'Pre-Clearance Intervention Officers were surveyed in August/September 2016 regarding satisfaction levels together with other feedback on the service.',
        },
        { title: 'Cost per transaction', body: 'This data is not available.' },
        {
          title: 'Digital take-up',
          body:
            'Digital take-up measures the percentage of import declaration lines where a permit number was provided electronically.',
        },
        { title: 'Completion rate', body: 'This data is not available.' },
      ],
      url: '',
      target_users: 'Importers and brokers',
      display_hero: true,
      display_kpis: true,
      published_at: '2017-01-07T05:07:57.044Z',
    },
    {
      id: 6,
      ...
      notes: [
        ...
        {
          title: 'What is Medicare Newborn Enrolment?',
          body:
        ...
        {
          title: 'Who is the user group of Medicare Newborn Enrolment?',
          body:
      ...
      display_hero: true,
      display_kpis: true,
      published_at: '2017-01-07T05:07:57.231Z',
    },
  ],
  widgets: [
    {
    ...
    },
    {
      ...
      units: 'n',
      description:
        'As of April, 43% of accounts are linked to more than one member service.',
      options: {},
      is_hero: false,
    ...
    },
    {
      ...
      units: 'n',
      description:
        'Chrome was the most popular browser used to access myGov with over 104 million hits.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-08-25T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: 'n',
      description:
        'The average number of member services visited for each sign-in.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-12-28T01:01:01.111Z',
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows the types of devices used by users to access the appointment booking service.',
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows the types of browsers used by users to access the appointment booking service.',
      options: { displayRoundedData: true, stacking: 'percentage' },
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
    ...
    },
    {
      ...
      units: 'n',
      description:
        'Prior to the digital transformation clients could only reschedule a citizenship test appointment to a more suitable time by calling the Department.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: 'n',
      description:
        'The Appointment Booking Service was developed to replace the Department’s existing booking system. User research found that users wanted a more efficient and effective way to reschedule their citizenship test appointment to a time and/or day that better suited them. ',
      options: {},
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows the percentage of users who click through to an external website from the Hobby or Business tool. Please note that these figures represent aggregated clicks to external government sites.',
      options: { displayRoundedData: false, stacking: 'percentage' },
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows the percentage of visits to the tool that came directly from business.gov.au or other external sites ie government, private sector or social media.',
      options: { displayRoundedData: true, stacking: 'percentage' },
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows number of users who sought help from the contact centre about the Hobby or Business tool as a percentage of overall number of visits to business.gov.au.',
      options: { displayRoundedData: false, stacking: 'percentage' },
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows the types of devices used by users to access the Hobby or Business tool.',
      options: { displayRoundedData: true, stacking: 'percentage' },
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
    ...
    },
    {
      ...
      units: 'f',
      description:
        '85% of users who received a business or hobby result thought the tool was helpful.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-11-09T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      options: {},
      is_hero: true,
      last_updated_at: '2016-11-07T01:01:01.111Z',
      data_updated_at: '2017-01-07T05:07:57.087Z',
      datasets: [74, 75, 77, 76],
    },
    {
      id: 40,
      dashboard_id: 4,
    ...
    },
    {
      ...
      row: 2,
      pos: 1,
      name: 'Time taken to clear permits',
      type: 'bar',
      size: 'medium',
      units: 's',
      description:
        'Time to clear measures the time between when a good requiring an import permit was held for assessment until the time it was cleared.',
      options: { displayRoundedData: true },
      is_hero: false,
      last_updated_at: '2016-12-07T01:01:01.111Z',
    ...
    },
    {
      ...
      units: 'n',
      description:
        'Australia has experienced a significant upturn in cargo volume with incoming air cargo of 33.6 million consignments, incoming sea cargo of 3.0 million in 2014-2015.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-11-07T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      options: {},
      is_hero: true,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: '2017-01-07T05:07:57.326Z',
      datasets: [79, 80, 85, 86],
    },
    {
      id: 47,
      dashboard_id: 6,
    ...
    },
    {
      ...
      units: '%',
      description:
        'This shows the percentage of newborns who were unable to be enrolled using the trial and the reason why.',
      options: { displayRoundedData: false, stacking: 'percentage' },
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: '2017-01-07T05:07:57.366Z',
      datasets: [87, 88, 89, 90, 91],
    },
    {
      id: 52,
      dashboard_id: 6,
      ...
      units: 'n',
      description:
        'This shows the total number of enrolled newborns compared to the total number of newborns.',
      options: { displayRoundedData: false },
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
    ...
    },
    {
      ...
      units: 'n',
      description:
        'This shows the total number of mothers participating in the newborn Medicare enrolments trial.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
    ...
    },
    {
      ...
      units: 'n',
      description:
        '30 day reduction in speed of enrolment because new mothers no longer need to complete a manual form.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: 'n',
      description:
        'Nearly 80% of applicants’ contact details are updated as a result of this process, this makes it far easier for them to interact with Medicare!',
      options: {},
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: 'n',
      description:
        '90.9% of new mothers eligible for the trial are now participating, compared to 22.4% in week 1.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: 'n',
      description:
        '100% of mothers who had previously enrolled a child said that the process had improved since their last enrolment.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      units: 'n',
      description:
        '1010 newborns were enrolled using the Medicare Newborn Enrolment Pilot.',
      options: {},
      is_hero: false,
      last_updated_at: '2016-09-13T01:01:01.111Z',
      data_updated_at: null,
    ...
    },
    {
      ...
      options: {},
      is_hero: true,
      last_updated_at: '2016-08-22T01:01:01.111Z',
      data_updated_at: null,
      datasets: [92, 93, 94, 95],
    },
    {
      id: 60,
      dashboard_id: 7,
  ...
  datasets: [
    ...
    },
    {
      ...
      units: 'n',
      notes:
        'The average number of member services a user visits during sign-in',
    ...
    },
    {
      ...
      units: '%',
      notes:
        "The percentage of visitors to the business.gov.au 'A business or a hobby?' page who go on to use the tool. This is calculated by dividing the total number of ..... by the total number of .......",
    ...
    },
    {
      ...
      units: '%',
      notes:
        'The percentage of users who successfully generate a result after starting the tool. This is calculated by dividing the total number of successfully completed transactions by the total number of started transactions.',
    ...
    },
    {
      ...
      units: '%',
      notes:
        'Digital take-up measures the percentage of import permits that are available in the Permit Verification Service.',
    ...
    },
    {
      ...
      units: 'i',
      notes:
        'This shows the average time taken to clear a permit using the Permit Verifcation Service.',
  ...
  datapoints: [
    ...
    },
    {
      id: 10,
      value: null,
      updated_at: '2017-01-07T05:07:52.329Z',
    ...
    },
    {
      id: 8,
      value: null,
      updated_at: '2017-01-07T05:07:52.321Z',
    ...
    },
    {
      id: 6,
      value: null,
      updated_at: '2017-01-07T05:07:52.314Z',
    ...
    },
    {
      id: 4,
      value: '41.37',
      updated_at: '2017-01-07T05:07:52.305Z',
    ...
    },
    {
      id: 2,
      value: '41.7',
      updated_at: '2017-01-07T05:07:52.282Z',
    ...
    },
    {
      id: 22,
      value: null,
      updated_at: '2017-01-07T05:07:52.378Z',
      ts: '2016-11-01 00:00:00.000',
    },
    {
      id: 21,
    ...
    },
    {
      id: 20,
      value: null,
      updated_at: '2017-01-07T05:07:52.372Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 19,
    ...
    },
    {
      id: 18,
      value: null,
      updated_at: '2017-01-07T05:07:52.365Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 17,
    ...
    },
    {
      id: 16,
      value: null,
      updated_at: '2017-01-07T05:07:52.357Z',
      ts: '2016-05-01 00:00:00.000',
    },
    {
      id: 15,
    ...
    },
    {
      id: 14,
      value: '26.33',
      updated_at: '2017-01-07T05:07:52.347Z',
      ts: '2016-03-01 00:00:00.000',
    },
    {
      id: 13,
    ...
    },
    {
      id: 12,
      value: '28.65',
      updated_at: '2017-01-07T05:07:52.340Z',
      ts: '2016-01-01 00:00:00.000',
    },
    {
      id: 33,
    ...
    },
    {
      id: 32,
      value: null,
      updated_at: '2017-01-07T05:07:52.420Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 31,
    ...
    },
    {
      id: 30,
      value: null,
      updated_at: '2017-01-07T05:07:52.412Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 29,
    ...
    },
    {
      id: 28,
      value: null,
      updated_at: '2017-01-07T05:07:52.405Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 27,
    ...
    },
    {
      id: 26,
      value: '30.74',
      updated_at: '2017-01-07T05:07:52.398Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 25,
    ...
    },
    {
      id: 24,
      value: '26.2',
      updated_at: '2017-01-07T05:07:52.389Z',
      ts: '2016-02-01 00:00:00.000',
    },
    {
      id: 23,
    ...
    },
    {
      id: 44,
      value: null,
      updated_at: '2017-01-07T05:07:52.470Z',
      ts: '2016-11-01 00:00:00.000',
    },
    {
      id: 43,
    ...
    },
    {
      id: 42,
      value: null,
      updated_at: '2017-01-07T05:07:52.463Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 41,
    ...
    },
    {
      id: 40,
      value: null,
      updated_at: '2017-01-07T05:07:52.456Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 39,
    ...
    },
    {
      id: 38,
      value: null,
      updated_at: '2017-01-07T05:07:52.448Z',
      ts: '2016-05-01 00:00:00.000',
    },
    {
      id: 37,
    ...
    },
    {
      id: 36,
      value: '2.81',
      updated_at: '2017-01-07T05:07:52.440Z',
      ts: '2016-03-01 00:00:00.000',
    },
    {
      id: 35,
    ...
    },
    {
      id: 34,
      value: '3.68',
      updated_at: '2017-01-07T05:07:52.432Z',
      ts: '2016-01-01 00:00:00.000',
    },
    {
      id: 55,
    ...
    },
    {
      id: 54,
      value: null,
      updated_at: '2017-01-07T05:07:52.510Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 53,
    ...
    },
    {
      id: 52,
      value: null,
      updated_at: '2017-01-07T05:07:52.502Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 51,
    ...
    },
    {
      id: 50,
      value: null,
      updated_at: '2017-01-07T05:07:52.495Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 49,
    ...
    },
    {
      id: 48,
      value: '0.91',
      updated_at: '2017-01-07T05:07:52.487Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 47,
    ...
    },
    {
      id: 46,
      value: '1.26',
      updated_at: '2017-01-07T05:07:52.480Z',
      ts: '2016-02-01 00:00:00.000',
    },
    {
      id: 45,
    ...
    },
    {
      id: 86,
      value: '18.1',
      updated_at: '2017-01-07T05:07:52.642Z',
      ts: '2016-11-01 00:00:00.000',
    },
    {
      id: 85,
    ...
    },
    {
      id: 84,
      value: '15.6',
      updated_at: '2017-01-07T05:07:52.635Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 83,
    ...
    },
    {
      id: 82,
      value: '14.2',
      updated_at: '2017-01-07T05:07:52.627Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 81,
    ...
    },
    {
      id: 80,
      value: '24.3',
      updated_at: '2017-01-07T05:07:52.619Z',
      ts: '2016-05-01 00:00:00.000',
    },
    {
      id: 79,
    ...
    },
    {
      id: 78,
      value: '25.1',
      updated_at: '2017-01-07T05:07:52.609Z',
      ts: '2016-03-01 00:00:00.000',
    },
    {
      id: 77,
    ...
    },
    {
      id: 76,
      value: '29.4',
      updated_at: '2017-01-07T05:07:52.598Z',
      ts: '2016-01-01 00:00:00.000',
    },
    {
      id: 75,
    ...
    },
    {
      id: 74,
      value: '24.9',
      updated_at: '2017-01-07T05:07:52.589Z',
    ...
    },
    {
      id: 72,
      value: '23.5',
      updated_at: '2017-01-07T05:07:52.581Z',
    ...
    },
    {
      id: 70,
      value: '21.1',
      updated_at: '2017-01-07T05:07:52.574Z',
    ...
    },
    {
      id: 68,
      value: '36.4',
      updated_at: '2017-01-07T05:07:52.567Z',
    ...
    },
    {
      id: 66,
      value: '41.3',
      updated_at: '2017-01-07T05:07:52.560Z',
    ...
    },
    {
      id: 64,
      value: '33.3',
      updated_at: '2017-01-07T05:07:52.553Z',
    ...
    },
    {
      id: 62,
      value: '29.3',
      updated_at: '2017-01-07T05:07:52.546Z',
    ...
    },
    {
      id: 60,
      value: '22.2',
      updated_at: '2017-01-07T05:07:52.538Z',
    ...
    },
    {
      id: 58,
      value: '17.7',
      updated_at: '2017-01-07T05:07:52.530Z',
    ...
    },
    {
      id: 56,
      value: '40.6',
      updated_at: '2017-01-07T05:07:52.523Z',
    ...
    },
    {
      id: 100,
      value: '17.1',
      updated_at: '2017-01-07T05:07:52.713Z',
      ts: '2015-06-01 00:00:00.000',
    },
    {
      id: 99,
    ...
    },
    {
      id: 98,
      value: '18.0',
      updated_at: '2017-01-07T05:07:52.704Z',
      ts: '2015-04-01 00:00:00.000',
    },
    {
      id: 97,
    ...
    },
    {
      id: 96,
      value: '17.9',
      updated_at: '2017-01-07T05:07:52.688Z',
      ts: '2015-02-01 00:00:00.000',
    },
    {
      id: 95,
    ...
    },
    {
      id: 94,
      value: '21.0',
      updated_at: '2017-01-07T05:07:52.678Z',
      ts: '2014-12-01 00:00:00.000',
    },
    {
      id: 93,
    ...
    },
    {
      id: 92,
      value: '22.2',
      updated_at: '2017-01-07T05:07:52.668Z',
      ts: '2014-10-01 00:00:00.000',
    },
    {
      id: 91,
    ...
    },
    {
      id: 90,
      value: '22.1',
      updated_at: '2017-01-07T05:07:52.660Z',
      ts: '2014-08-01 00:00:00.000',
    },
    {
      id: 89,
    ...
    },
    {
      id: 88,
      value: '21.2',
      updated_at: '2017-01-07T05:07:52.653Z',
      ts: '2014-06-01 00:00:00.000',
    },
    {
      id: 87,
    ...
    },
    {
      id: 143,
      value: '6.3',
      updated_at: '2017-01-07T05:07:52.909Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 142,
    ...
    },
    {
      id: 141,
      value: '3.7',
      updated_at: '2017-01-07T05:07:52.900Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 140,
    ...
    },
    {
      id: 139,
      value: '4.0',
      updated_at: '2017-01-07T05:07:52.891Z',
      ts: '2016-02-01 00:00:00.000',
    },
    {
      id: 138,
    ...
    },
    {
      id: 137,
      value: '4.1',
      updated_at: '2017-01-07T05:07:52.882Z',
      ts: '2015-12-01 00:00:00.000',
    },
    {
      id: 136,
    ...
    },
    {
      id: 134,
      value: '9.8',
      updated_at: '2017-01-07T05:07:52.868Z',
      ts: '2015-09-01 00:00:00.000',
    },
    {
      id: 133,
    ...
    },
    {
      id: 131,
      value: '4.6',
      updated_at: '2017-01-07T05:07:52.856Z',
      ts: '2015-06-01 00:00:00.000',
    },
    {
      id: 130,
    ...
    },
    {
      id: 129,
      value: '3.7',
      updated_at: '2017-01-07T05:07:52.848Z',
      ts: '2015-04-01 00:00:00.000',
    },
    {
      id: 128,
    ...
    },
    {
      id: 127,
      value: '3.9',
      updated_at: '2017-01-07T05:07:52.838Z',
      ts: '2015-02-01 00:00:00.000',
    },
    {
      id: 126,
    ...
    },
    {
      id: 125,
      value: '4.2',
      updated_at: '2017-01-07T05:07:52.828Z',
      ts: '2014-12-01 00:00:00.000',
    },
    {
      id: 124,
    ...
    },
    {
      id: 119,
      value: '7.9',
      updated_at: '2017-01-07T05:07:52.800Z',
      ts: '2014-06-01 00:00:00.000',
    },
    {
      id: 118,
    ...
    },
    {
      id: 1055,
      value: null,
      updated_at: '2017-01-07T08:59:56.094Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 252,
    ...
    },
    {
      id: 1054,
      value: null,
      updated_at: '2017-01-07T08:59:56.092Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 273,
    ...
    },
    {
      id: 1057,
      value: null,
      updated_at: '2017-01-07T08:59:56.109Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 294,
    ...
    },
    {
      id: 293,
      value: '4.8',
      updated_at: '2017-01-07T05:07:53.565Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 292,
    ...
    },
    {
      id: 276,
      value: '3.0',
      updated_at: '2017-01-07T05:07:53.505Z',
      ts: '2015-05-01 00:00:00.000',
    },
    {
      id: 275,
    ...
    },
    {
      id: 1058,
      value: null,
      updated_at: '2017-01-07T08:59:56.183Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 315,
    ...
    },
    {
      id: 314,
      value: '1.6',
      updated_at: '2017-01-07T05:07:53.673Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 313,
    ...
    },
    {
      id: 312,
      value: '1.5',
      updated_at: '2017-01-07T05:07:53.664Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 311,
    ...
    },
    {
      id: 348,
      value: '0.6',
      updated_at: '2017-01-07T05:07:53.801Z',
      ts: '2016-02-01 00:00:00.000',
    },
    {
      id: 347,
    ...
    },
    {
      id: 371,
      value: '1.2',
      updated_at: '2017-01-07T05:07:53.884Z',
      ts: '2016-05-01 00:00:00.000',
    },
    {
      id: 370,
    ...
    },
    {
      id: 1049,
      value: null,
      updated_at: '2017-01-07T05:18:48.897Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 462,
    ...
    },
    {
      id: 1051,
      value: null,
      updated_at: '2017-01-07T05:18:48.913Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 483,
    ...
    },
    {
      id: 480,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.301Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 479,
    ...
    },
    {
      id: 478,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.293Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 477,
    ...
    },
    {
      id: 476,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.285Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 475,
    ...
    },
    {
      id: 474,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.276Z',
      ts: '2016-02-01 00:00:00.000',
    },
    {
      id: 473,
    ...
    },
    {
      id: 472,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.268Z',
      ts: '2015-12-01 00:00:00.000',
    },
    {
      id: 471,
    ...
    },
    {
      id: 470,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.261Z',
      ts: '2015-10-01 00:00:00.000',
    },
    {
      id: 469,
    ...
    },
    {
      id: 468,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.254Z',
      ts: '2015-08-01 00:00:00.000',
    },
    {
      id: 467,
    ...
    },
    {
      id: 466,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.247Z',
      ts: '2015-06-01 00:00:00.000',
    },
    {
      id: 465,
    ...
    },
    {
      id: 464,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.240Z',
      ts: '2015-04-01 00:00:00.000',
    },
    {
      id: 463,
    ...
    },
    {
      id: 1048,
      value: null,
      updated_at: '2017-01-07T05:18:48.877Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 504,
    ...
    },
    {
      id: 501,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.389Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 500,
    ...
    },
    {
      id: 499,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.380Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 498,
    ...
    },
    {
      id: 497,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.372Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 496,
    ...
    },
    {
      id: 495,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.364Z',
      ts: '2016-02-01 00:00:00.000',
    },
    {
      id: 494,
    ...
    },
    {
      id: 493,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.357Z',
      ts: '2015-12-01 00:00:00.000',
    },
    {
      id: 492,
    ...
    },
    {
      id: 491,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.349Z',
      ts: '2015-10-01 00:00:00.000',
    },
    {
      id: 490,
    ...
    },
    {
      id: 489,
      value: '7.0',
      updated_at: '2017-01-07T05:07:54.341Z',
      ts: '2015-08-01 00:00:00.000',
    },
    {
      id: 488,
    ...
    },
    {
      id: 487,
      value: '8.0',
      updated_at: '2017-01-07T05:07:54.333Z',
      ts: '2015-06-01 00:00:00.000',
    },
    {
      id: 486,
    ...
    },
    {
      id: 485,
      value: '8.0',
      updated_at: '2017-01-07T05:07:54.324Z',
      ts: '2015-04-01 00:00:00.000',
    },
    {
      id: 484,
    ...
    },
    {
      id: 1050,
      value: null,
      updated_at: '2017-01-07T05:18:48.911Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 525,
    ...
    },
    {
      id: 1052,
      value: null,
      updated_at: '2017-01-07T05:18:49.098Z',
      ts: '2016-12-01 00:00:00.000',
    },
    {
      id: 546,
    ...
    },
    {
      id: 544,
      value: '3.7',
      updated_at: '2017-01-07T05:07:54.570Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 543,
    ...
    },
    {
      id: 542,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.562Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 541,
    ...
    },
    {
      id: 540,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.554Z',
      ts: '2016-05-01 00:00:00.000',
    },
    {
      id: 539,
    ...
    },
    {
      id: 538,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.546Z',
      ts: '2016-03-01 00:00:00.000',
    },
    {
      id: 537,
    ...
    },
    {
      id: 536,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.538Z',
      ts: '2016-01-01 00:00:00.000',
    },
    {
      id: 535,
    ...
    },
    {
      id: 534,
      value: '3.0',
      updated_at: '2017-01-07T05:07:54.520Z',
      ts: '2015-11-01 00:00:00.000',
    },
    {
      id: 533,
    ...
    },
    {
      id: 532,
      value: '2.0',
      updated_at: '2017-01-07T05:07:54.511Z',
      ts: '2015-09-01 00:00:00.000',
    },
    {
      id: 531,
    ...
    },
    {
      id: 530,
      value: '2.0',
      updated_at: '2017-01-07T05:07:54.503Z',
      ts: '2015-07-01 00:00:00.000',
    },
    {
      id: 529,
    ...
    },
    {
      id: 528,
      value: '2.0',
      updated_at: '2017-01-07T05:07:54.495Z',
      ts: '2015-05-01 00:00:00.000',
    },
    {
      id: 527,
    ...
    },
    {
      id: 526,
      value: '2.0',
      updated_at: '2017-01-07T05:07:54.488Z',
      ts: '2015-03-01 00:00:00.000',
    },
    {
      id: 585,
    ...
    },
    {
      id: 584,
      value: null,
      updated_at: '2017-01-07T05:07:54.724Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 583,
    ...
    },
    {
      id: 582,
      value: null,
      updated_at: '2017-01-07T05:07:54.717Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 581,
    ...
    },
    {
      id: 580,
      value: null,
      updated_at: '2017-01-07T05:07:54.710Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 579,
    ...
    },
    {
      id: 574,
      value: null,
      updated_at: '2017-01-07T05:07:54.689Z',
      ts: '2015-12-01 00:00:00.000',
    },
    {
      id: 573,
    ...
    },
    {
      id: 572,
      value: null,
      updated_at: '2017-01-07T05:07:54.682Z',
      ts: '2015-10-01 00:00:00.000',
    },
    {
      id: 571,
    ...
    },
    {
      id: 570,
      value: null,
      updated_at: '2017-01-07T05:07:54.673Z',
      ts: '2015-08-01 00:00:00.000',
    },
    {
      id: 569,
    ...
    },
    {
      id: 605,
      value: null,
      updated_at: '2017-01-07T05:07:54.819Z',
      ts: '2016-11-01 00:00:00.000',
    },
    {
      id: 604,
    ...
    },
    {
      id: 603,
      value: null,
      updated_at: '2017-01-07T05:07:54.813Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 602,
    ...
    },
    {
      id: 601,
      value: null,
      updated_at: '2017-01-07T05:07:54.806Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 600,
    ...
    },
    {
      id: 595,
      value: null,
      updated_at: '2017-01-07T05:07:54.783Z',
      ts: '2015-12-01 00:00:00.000',
    },
    {
      id: 594,
    ...
    },
    {
      id: 593,
      value: null,
      updated_at: '2017-01-07T05:07:54.764Z',
      ts: '2015-10-01 00:00:00.000',
    },
    {
      id: 592,
    ...
    },
    {
      id: 591,
      value: null,
      updated_at: '2017-01-07T05:07:54.751Z',
      ts: '2015-08-01 00:00:00.000',
    },
    {
      id: 590,
    ...
    },
    {
      id: 625,
      value: null,
      updated_at: '2017-01-07T05:07:54.889Z',
      ts: '2016-11-01 00:00:00.000',
    },
    {
      id: 624,
    ...
    },
    {
      id: 623,
      value: null,
      updated_at: '2017-01-07T05:07:54.883Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 622,
    ...
    },
    {
      id: 621,
      value: null,
      updated_at: '2017-01-07T05:07:54.876Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 620,
    ...
    },
    {
      id: 615,
      value: null,
      updated_at: '2017-01-07T05:07:54.855Z',
      ts: '2015-12-01 00:00:00.000',
    },
    {
      id: 614,
    ...
    },
    {
      id: 613,
      value: null,
      updated_at: '2017-01-07T05:07:54.849Z',
      ts: '2015-10-01 00:00:00.000',
    },
    {
      id: 612,
    ...
    },
    {
      id: 611,
      value: null,
      updated_at: '2017-01-07T05:07:54.842Z',
      ts: '2015-08-01 00:00:00.000',
    },
    {
      id: 610,
    ...
    },
    {
      id: 631,
      value: '9.5',
      updated_at: '2017-01-07T05:07:54.912Z',
      ts: '2015-08-01 00:00:00.000',
    },
    {
      id: 630,
    ...
    },
    {
      id: 726,
      value: '3.8',
      updated_at: '2017-01-07T05:07:55.319Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 725,
    ...
    },
    {
      id: 717,
      value: '4.5',
      updated_at: '2017-01-07T05:07:55.289Z',
      ts: '2015-10-01 00:00:00.000',
    },
    {
      id: 716,
    ...
    },
    {
      id: 828,
      value: '1.9',
      updated_at: '2017-01-07T05:07:56.015Z',
      ts: '2016-03-01 00:00:00.000',
    },
    {
      id: 843,
    ...
    },
    {
      id: 851,
      value: '5.0',
      updated_at: '2017-01-07T05:07:56.104Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 850,
    ...
    },
    {
      id: 849,
      value: '5.0',
      updated_at: '2017-01-07T05:07:56.093Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 848,
    ...
    },
    {
      id: 847,
      value: '2.0',
      updated_at: '2017-01-07T05:07:56.086Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 846,
    ...
    },
    {
      id: 845,
      value: '6.0',
      updated_at: '2017-01-07T05:07:56.079Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 844,
    ...
    },
    {
      id: 891,
      value: '5.0',
      updated_at: '2017-01-07T05:07:56.259Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 890,
    ...
    },
    {
      id: 889,
      value: '5.0',
      updated_at: '2017-01-07T05:07:56.253Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 888,
    ...
    },
    {
      id: 887,
      value: '6.0',
      updated_at: '2017-01-07T05:07:56.246Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 886,
    ...
    },
    {
      id: 885,
      value: '6.0',
      updated_at: '2017-01-07T05:07:56.239Z',
      ts: '2016-04-01 00:00:00.000',
    },
    {
      id: 884,
    ...
    },
    {
      id: 899,
      value: '4.0',
      updated_at: '2017-01-07T05:07:56.289Z',
      ts: '2016-10-01 00:00:00.000',
    },
    {
      id: 898,
    ...
    },
    {
      id: 897,
      value: '4.0',
      updated_at: '2017-01-07T05:07:56.282Z',
      ts: '2016-08-01 00:00:00.000',
    },
    {
      id: 896,
    ...
    },
    {
      id: 900,
      value: null,
      updated_at: '2017-01-07T05:07:56.445Z',
      ts: '2016-06-01 00:00:00.000',
    },
    {
      id: 907,
    ...
    },
    {
      id: 913,
      value: '7.0',
      updated_at: '2017-01-07T05:07:56.501Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 912,
    ...
    },
    {
      id: 927,
      value: '5.0',
      updated_at: '2017-01-07T05:07:56.557Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 926,
    ...
    },
    {
      id: 925,
      value: '3.0',
      updated_at: '2017-01-07T05:07:56.550Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 924,
    ...
    },
    {
      id: 947,
      value: '1.6',
      updated_at: '2017-01-07T05:07:56.650Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 946,
    ...
    },
    {
      id: 945,
      value: '0.4',
      updated_at: '2017-01-07T05:07:56.643Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 944,
    ...
    },
    {
      id: 959,
      value: '7.0',
      updated_at: '2017-01-07T05:07:56.718Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 958,
    ...
    },
    {
      id: 957,
      value: '8.0',
      updated_at: '2017-01-07T05:07:56.709Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 956,
    ...
    },
    {
      id: 979,
      value: '5.0',
      updated_at: '2017-01-07T05:07:56.850Z',
      ts: '2016-09-01 00:00:00.000',
    },
    {
      id: 978,
    ...
    },
    {
      id: 977,
      value: '5.3',
      updated_at: '2017-01-07T05:07:56.839Z',
      ts: '2016-07-01 00:00:00.000',
    },
    {
      id: 976,
    ...
    },
    {
      id: 1041,
      value: '0.0',
      updated_at: '2017-01-07T05:07:57.432Z',
      ts: '2016-04-01 00:00:00.000',
    },
  ],
};
