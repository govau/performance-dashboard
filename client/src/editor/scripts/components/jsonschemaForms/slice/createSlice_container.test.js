...
describe('(Form) Create Slice Container - createSlice_container', () => {
  ...
  it('should render deeply without exploding', () => {
    ...
    const denormalizedEmptyFixtureSlice = getEmptyDenormalizedSlice(
      fixtureComposedState,
      {
    ...
    if (denormalizedEmptyFixtureSlice === null)
      throw new Error('invalid denormalizedEmptyFixtureSlice');
