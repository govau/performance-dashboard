...
const getDenormalizedTempSlice = (
  tempSlice,
  { widget, dashboard, datasets },
) => {
  return {
    widget: widget,
    dashboard: dashboard,
...
const mapStateToProps = (state, ownProps) => {
  ...
  const denormalizedTempSlice = getDenormalizedTempSlice(
    currentNormalizedSlice,
    {
  ...
  const mergedDenormalizedSlices = [
    ...denormalizedSavedSlices,
    denormalizedTempSlice,
  ];
