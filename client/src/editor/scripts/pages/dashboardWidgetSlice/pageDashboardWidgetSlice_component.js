...
const DashboardWidgetDatagroupTimeSeriesPage = props => {
  ...
  return (
    <PageLayout
      pageKey="dashboardwidgetdatagrouptimeseries"
      breadcrumbPaths={[
    ...
    >
      <div>
        <div className="timeseries-pagination">
          <span className="timeseries-pagination__supp-title">
            {isEmptySlice(slice) ? 'Add' : 'Edit'} data for:
          </span>
        ...
        {metadata.widget_form_help && (
          <p className="page-dashboardwidgetdatagrouptimeseries__form-help">
            {metadata.widget_form_help}
          </p>
        )}
